  ...
  return (
    ...
    >
      <div
        className={clsx(
          'w-9 rounded-lg',
          isActive ? 'bg-gradient-to-tr from-purple-400 to-red-400' : 'bg-slate-500',
        )}
      >
    ...
    <Tab.Group as="div" className="hidden lg:mt-20 lg:block">
      {({ selectedIndex }) => (
        <>
          ...
          <Tab.Panels className="relative mt-20 overflow-hidden rounded-4xl bg-transparent px-14 py-16 xl:px-16">
